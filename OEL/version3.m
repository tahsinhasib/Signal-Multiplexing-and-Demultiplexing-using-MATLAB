...
figure
trec1 = bp1/99:bp1/99:bp1*length(x1);
Rec1 = awgn(ask1, 10);
subplot(3,1,1);
plot(trec1, Rec1);
axis([0 bp1*length(x1) -6 6]);
xlabel('Time(sec)');
ylabel('Amplitude(volt)');
title('Demultiplexed ASK - 1 Signal');

trec2 = bp2/99:bp2/99:bp2*length(x2);
Rec2 = awgn(ask2, 10);
subplot(3,1,2);
plot(trec2, Rec2);
axis([0 bp1*length(x2) -6 6]);
xlabel('Time(sec)');
ylabel('Amplitude(volt)');
title('Demultiplexed ASK - 2 Signal');


trec3 = bp3/99:bp3/99:bp3*length(x3);
Rec3 = awgn(ask3, 10);
subplot(3,1,3);
plot(trec3, Rec3);
axis([0 bp1*length(x3) -6 6]);
xlabel('Time(sec)');
ylabel('Amplitude(volt)');
